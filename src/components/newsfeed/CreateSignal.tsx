    ...
    onSubmit: async (values) => {
      try {
        if (values.expiry) {
          ...
          console.log("expiry", new Date(values.expiry).getTime());
        ...
        <div className="d-flex justify-content-between flex-sm-row flex-column mt-2 mt-md-3 gap-2">
          ...
          >
            <TextField
              ...
              // }
              onBlur={formik.handleBlur}
              onChange={(e) => formik.setFieldValue("entry", e.target.value)}
              InputProps={{
                style: {
                  borderRadius: "5px",
                },
          ...
          >
            <TextField
              ...
              // }
              onBlur={formik.handleBlur}
              onChange={(e) => formik.setFieldValue("stop", e.target.value)}
              InputProps={{
                style: {
                  borderRadius: "5px",
                },
