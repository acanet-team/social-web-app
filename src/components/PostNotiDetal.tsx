...
const DetailPostNoti = (props: { id: string }) => {
  const { id } = props;
  ...
  return (
    <>
      {dataPost && (
        ...
        //                 // onClick={(e) => onDeletePost(e, id as string)}
        //               >
        //                 Delete
        //               </div>
        //             )}
        ...
        //             onClick={(e) => onClickLikeHandler(e, id as string, likeNum)}
        //           ></i>
